...
class moeDocLN:
    class Authentication:
        ...
        def retrieve_larvile_token(url: str, login_cookies: dict = {}) -> dict: 
            """
                Retrieve Larvile token, return token as str or False if fail.
            """
        ...
        def get_login_cookies(username: str, password: str, isTemporary = False) -> str:
            """
                return login cookies as dict, return False if fail.
            """
            start = time()
            ...
            if response.status_code == 200:
                ...
                log("Cannot reach server. Status code: " + str(response.status_code))
                return False
    
    class NovelsActions:
        @staticmethod
        def create_novel(login_cookies: dict, title: str, author: str, illustrator: str, genres: list, summary: str, extra: str, type_: int = 2, group_id: int = 1, altname: str = '', is_mature: int = 0, status: int = 2) -> int:
            """
                Create novel, return True if success. otherwise. return False.
            """
        ...
        @staticmethod
        def edit_novel(login_cookies: dict, series_id: int, title: str, altname: str, author: str, illustrator: str, summary: str, genres: list, status: str, extra: str) -> bool:
            """
                Edit novel details, return True if success, otherwise, return False
            """
        ...
        @staticmethod
        def update_cover(cover_path: str, series_id: int, login_cookies: dict) -> bool:
            """
                Update novel cover, return True if success, otherwise, return False
            """
            token = moeDocLN.Authentication.retrieve_larvile_token(f'https://docln.sbs/action/series/{series_id}/edit', login_cookies)
        ...
        @staticmethod
        def delete_novel(login_cookies: dict, series_id: int) -> bool:
            """
                Delete novel, return True if success, otherwise, return False   
            """
    ...
    class BookActions:
        @staticmethod
        #Please make this into a dict later - wdym??
        def get_book_id(login_cookies: dict, series_id: int) -> list:
            """
                get book ids (Volumne) of a novel, return list of book ids if success, otherwise, return False
            """
        ...
        @staticmethod
        def create_book(login_cookies: dict, series_id: int, title: str) -> bool:
            """
                Create book (Volume), return True if success, otherwise, return False
            """
    ...
    class ChapterActions:
        @staticmethod
        def create_chapter(login_cookies: dict, book_id: int, title: str, content: str = "") -> bool:
            """
                Create chapter, return True if success, otherwise, return False
            """
        ...
        @staticmethod
        def create_note(login_cookies: dict, book_id: int, content: str, larvile_token: str) -> int:
            """
                Create note inside a chapter. Return NoteID if success, otherwise, return False 
            """
            token = larvile_token
